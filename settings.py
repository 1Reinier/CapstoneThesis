...
# -- BANK NETWORK --
NUMBER_OF_BANKS_LOGNORMAL = 630  # As in the 2014 paper by Goddard on the asset size distribution of the
NUMBER_OF_BANKS_PARETO = 18      # US banking market. [1] +/- 180 banks control 85% of all assets.
